...
namespace ElasticsearchWarmers.ElasticsearchProvider
{
	public class SearchProvider
	{
		...
		public IEnumerable<FastestAnimal> Search(string searchTerm)
		{
			...
			return hits.PayloadResult.Hits.HitsResult.Select(t => t.Source);
		}

		public void CreateIndexWithWarmerAndAddData()
		{
